...
<body class="gray-bg">
					...
					<div class="ibox-content">
						<form id="ArticleHealthForm" name="ArticleHealthForm" class="form-horizontal" method="post">
							...
							<div class="form-group">
							    ...
							    <div class="col-sm-4">
									<input type="text" class="form-control" name="EXPERT_NAME" id="EXPERT_NAME" value="${pd.EXPERT_NAME}" />
								</div>
								<label class="col-sm-2 control-label">职称：</label>
							    <div class="col-sm-4">
									<input type="text" class="form-control" name="EXPERT_DUTY" id="EXPERT_DUTY" value="${pd.EXPERT_DUTY}" />
								</div>
							</div>
							<div class="form-group">
								<label class="col-sm-2 control-label">所属医院：</label>
							    <div class="col-sm-4">
									<input type="text" class="form-control" name="EXPERT_HOSP" id="EXPERT_HOSP" value="${pd.EXPERT_HOSP}" />
								</div>
								<label class="col-sm-2 control-label">所属科室：</label>
							    <div class="col-sm-4">
							    	<select class="form-control" name="EXPERT_DEPT" id="EXPERT_DEPT" value="${pd.EXPERT_DEPT}"
	...
	<script type="text/javascript">
	    ...
	    function submitForm(){
	    	$.ajax({
				type: "POST",
				url: '<%=basePath%>articleHealth/checkKeyWords?tm=' +  new Date().getTime(),
