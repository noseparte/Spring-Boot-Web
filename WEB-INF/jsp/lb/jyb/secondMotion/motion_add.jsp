...
<body class="gray-bg">
            ...
            <div class="col-sm-12">
                <div class="ibox float-e-margins">
                    ...
                    <div class="ibox-content">
                        <form action="jyb/secondMotion/saveAdd"  method="post" class="form-horizontal" name="formMotion" id="formMotion">
                            ...
                            <div class="form-group">
                                <label class="col-sm-2 control-label">选择地域</label>
                                <div class="col-sm-4">
                                    <select class="form-control required" name="HE_AREA" id="HE_AREA" value="${pd.HE_AREA}" "
                                    	ajax--url="dic/getDicAreaForSelect" ajax--column="ID,TEXT" style="text-align: center;">
	...
	function save(){
		...
		if($("#HE_AREA").val == "" || $("#HE_AREA").val == null){
			$("#SNUMBER").tips({
				side:3,
	            msg:'输入地域信息',
	            bg:'#AE81FF',
...
// 			return false;
	...
	function goBack(){
		this.location.href="<%=basePath%>/jyb/secondMotion/toList";
	}
