...
<body class="gray-bg">
				...
				<div class="ibox float-e-margins">
					...
					<div class="ibox-content">
						<form id="ArticleRotationForm" name="ArticleRotationForm" class="form-horizontal" method="post">
							...
							<input type="hidden" name="HEL_AUDIT" id="HEL_AUDIT" value="${pd.HEL_AUDIT}" />
							<div class="form-group">
								<label class="col-sm-2 control-label">姓名：</label>
							    <div class="col-sm-4">
									<input type="text" class="form-control required" name="HEL_NAME" id="HEL_NAME" value="${pd.HEL_NAME}" disabled="disabled"/>
								</div>
							...
							<div class="form-group">
							    ...
							    <div class="col-sm-4">
							    	<input type="text" class="form-control required" name="HEL_SEX" id="HEL_SEX" value="${pd.HEL_SEX}" disabled="disabled"/>
								</div>
							...
							<div class="form-group">
							    ...
							    <div class="col-sm-4">
									<input type="text" class="form-control required" name="HD_NAME" id="HD_NAME" value="${pd.HD_NAME}" disabled="disabled"/>
								</div>
							</div>
							<div class="form-group">
							...
							<div class="form-group">
								...
								<%-- <label class="col-sm-2 control-label">教学背景：</label>
							    <div class="col-sm-4">
									<input type="text" class="form-control required" name="HEL_EDU" id="HEL_EDU" value="${pd.HEL_EDU}" />
								</div> --%>
							</div>
	...
	<script type="text/javascript">
			...
			$(formId).validate({
				rules: {
					PHONENUM: {
						rangelength: [11, 11],
						remote: {
							url: '/hospExpLib/findByIdForPhone',
							type: 'POST',
							dataType: 'JSON',
							data: {
								'HEL_PHONE': function() {
	    ...
	    function submitForm(){
	        ...
	        var HEL_PHOTO = $("#HEL_PHOTO").val();
	        if(HEL_PHOTO != null && HEL_PHOTO != ''){
		    	action = "hospExpLib/saveEditForEdit";
