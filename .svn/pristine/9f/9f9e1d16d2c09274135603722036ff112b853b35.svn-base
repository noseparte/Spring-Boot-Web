...
public class DictionariesController extends BaseController {
	...
	@ResponseBody
	public Object getSubDicAreaListByProvinceCode() throws Exception {
		PageData pd = this.getPageData();
		//pd.put("caa_pcode", pd.get("addr"));
		return this.pd(systemServer + "dic/getSubDicAreaListByProvinceCode", pd);
	}
}
