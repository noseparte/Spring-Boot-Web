...
public class AgencyOrderManagementController extends BaseController {
	...
	@ResponseBody
	public Object selectExpertOrders() {
		PageData pd = this.getPageData();
		return this.pd(systemServer + "agency/selectExpertOrders", pd);
	}
	/**
	 * 查询陪诊人员是否已接单
	 * 
	...
	@ResponseBody
	public Object selectAccompantOrders() {
		PageData pd = this.getPageData();
		return this.pd(systemServer + "agency/selectAccompantOrders", pd);
	}
