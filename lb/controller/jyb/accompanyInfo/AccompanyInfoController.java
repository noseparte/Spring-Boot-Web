...
public class AccompanyInfoController extends BaseController{
	/**
	 * 跳转列表页面
	 * 
	 * @return
	...
	public ModelAndView toLists() {
		return new ModelAndView("lb/jyb/accompanyInfo/list");
	}
	...
	public ModelAndView toAdd() {
		return new ModelAndView("lb/jyb/accompanyInfo/edit");
	}
	...
	public ModelAndView toEdit() throws Exception {
		...
		return this.viewAndPd("lb/jyb/accompanyInfo/edit", systemServer + "accompanyInfo/findById", pd);
	}
	...
	public ModelAndView toView() throws Exception {
		PageData pd = this.getPageData();
		return this.viewAndPd("lb/jyb/accompanyInfo/view", systemServer + "accompanyInfo/findById", pd);
	}
	...
	public ModelAndView saveAdd() throws Exception {
		...
		pd = this.savePage(pd);
		return this.viewAndPd("lb/jyb/accompanyInfo/list", systemServer + "accompanyInfo/saveAdd", pd);
	}
	...
	public ModelAndView saveEdit() throws Exception {
		...
		pd.put("TYPE", "4");
		pd.put("USER_ID",userId );
		return this.viewAndPd("lb/jyb/accompanyInfo/list", systemServer + "accompanyInfo/saveEdit", pd);
	}
