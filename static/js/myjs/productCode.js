 ...
 */	
	...
	function saveD(){
		...
		var fields = dname + ',pegoe,' + dtype + ',pegoe,' + dbz + ',pegoe,' + isQian + ',pegoe,' + ddefault;
	...
	function editField(value,msgIndex){
		var efieldarray = value.split(',pegoe,');
	...
	function appendC(value){
		...
		var fieldarray = value.split(',pegoe,');
	...
	function isSame(value){
		for(var i=0;i<arField.length;i++){
			var array0 = arField[i].split(',pegoe,')[0];
			if(array0 == value){
				return false;
			}
		}
